...
function isInstagramConnected(profile) {
    return Boolean(
...
function buildInfluencerProfileChecklist(profile) {
    ...
    const checklist = [
        ...
        { key: 'instagramConnected', label: 'Connect Instagram', done: isInstagramConnected(profile) },
    ];
...
module.exports = {
    buildInfluencerProfileChecklist,
