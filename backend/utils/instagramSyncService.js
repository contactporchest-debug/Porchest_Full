...
exports.runFullSync = async (userId, role, accessToken, options = {}) => {
    ...
    if (role === 'influencer') {
        ...
        updatePayload.avgShares            = metrics.avgSharesPerPost || 0;
        updatePayload.avgViews             = metrics.avgViewsPerPost || 0;
        updatePayload.avgReach             = metrics.avgReachPerPost || 0;
        updatePayload.avgReachPerPost      = metrics.avgReachPerPost || 0;
        updatePayload.avgLikesPerPost      = metrics.avgLikesPerPost || 0;
        updatePayload.avgCommentsPerPost   = metrics.avgCommentsPerPost || 0;
        updatePayload.avgSavesPerPost      = metrics.avgSavesPerPost || 0;
        updatePayload.avgSharesPerPost     = metrics.avgSharesPerPost || 0;
        ...
        updatePayload.avgImpressionsPerPost = metrics.avgImpressionsPerPost || 0;
