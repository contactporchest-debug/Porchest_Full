...
const DEMO_CAMPAIGNS = [
    ...
    },
    {
        ...
        counterOfferMessage: 'Can we include one extra story frame for product education?',
        sentAt: daysAgo(4),
        viewedAt: daysAgo(4),
    ...
    },
    {
        ...
        deliverables: '1 Carousel + 2 Story Frames',
    ...
    },
    {
        ...
        status: 'rejected',
        rejectionReason: 'Current schedule is full for sponsored story integrations this month.',
        sentAt: daysAgo(12),
        viewedAt: daysAgo(11),
    ...
    {
        influencerEmail: 'inf1@porchest.com',
        campaignTitle: 'Weekend Self-Care Story Sequence',
        campaignDescription: 'Light awareness burst using quick skincare ritual story frames during a relaxed weekend routine.',
        campaignType: 'story',
        deliverables: '4 Story Frames',
        ...
        brandMessage: 'Quick story burst to support the broader glow campaign.',
        status: 'sent',
        sentAt: daysAgo(1),
    },
];
