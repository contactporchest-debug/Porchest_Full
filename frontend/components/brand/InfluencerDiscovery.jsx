                            ...
                            <motion.div key={inf._id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }} style={{ overflow: 'hidden', borderRadius: '16px', border: '1px solid #EDD9BC', background: 'rgba(255,255,255,0.4)', boxShadow: '0 4px 20px rgba(26,10,0,0.05)' }}>
                                ...
                                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '12px' }}>
                                        <button type="button" onClick={() => router.push(`/dashboard/brand/influencers/${inf._id}`)} style={{ flex: 1, borderRadius: '8px', border: '1px solid #EDD9BC', background: 'rgba(255,255,255,0.8)', padding: '12px 16px', fontSize: '14px', fontWeight: 700, color: '#7A5030', transition: 'all 0.15s', cursor: 'pointer', fontFamily: 'inherit' }} onMouseEnter={e => { e.currentTarget.style.background = '#fff'; e.currentTarget.style.color = '#1A0A00'; }} onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.8)'; e.currentTarget.style.color = '#7A5030'; }}>
                                            View Profile
                                        </button>
                                        <button type="button" onClick={() => router.push(`/dashboard/brand/influencers/${inf._id}/analytics`)} style={{ flex: 1, borderRadius: '8px', border: '1px solid rgba(194,52,10,0.2)', background: 'rgba(194,52,10,0.08)', padding: '12px 16px', fontSize: '14px', fontWeight: 700, color: '#C2340A', transition: 'all 0.15s', cursor: 'pointer', fontFamily: 'inherit' }} onMouseEnter={e => { e.currentTarget.style.background = 'rgba(194,52,10,0.12)'; e.currentTarget.style.color = '#E8400A'; }} onMouseLeave={e => { e.currentTarget.style.background = 'rgba(194,52,10,0.08)'; e.currentTarget.style.color = '#C2340A'; }}>
                                            60d Analytics
                                        </button>
