                                        ...
                                        <div className="bg-[rgba(255,255,255,0.38)] border border-[rgba(255,255,255,0.65)] rounded-[14px] p-6 backdrop-blur-[12px]">
                                            ...
                                            {(selected.status === 'posted' || (selected.content?.postLink && !selected.content?.adminVerified)) && (
                                                <div className="mt-6 rounded-[14px] border border-[#EDD9BC] bg-[rgba(255,255,255,0.45)] p-4 backdrop-blur-[12px]">
                                                    ...
                                                    <p className="text-[#7A5030] text-xs mt-2">Verify the post to release the first payout.</p>
                                                    <div className="mt-3 flex gap-2 flex-wrap">
                                                        <button onClick={() => void handleVerify()} disabled={actioning} className="px-4 py-2 rounded-full bg-[#C2340A] hover:bg-[#E8400A] text-white text-sm font-medium disabled:opacity-50">
                                                            Verify & release first payout
                                                        </button>
                                                        <a href={selected.content?.postLink || '#'} target="_blank" rel="noreferrer" className="px-4 py-2 rounded-full bg-[rgba(255,255,255,0.48)] border border-[#EDD9BC] text-[#7A5030] text-sm font-medium inline-flex items-center gap-2">
                                            ...
                                            {selected.status !== 'completed' && selected.status !== 'cancelled' && (
                                                <button onClick={() => void handleStop()} disabled={actioning} className="mt-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#C2340A]/10 border border-[#EDD9BC] text-[#C2340A] text-sm font-medium hover:bg-[#C2340A]/15 disabled:opacity-50">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                                {[
                                                    ...
                                                    <div key={label} className="bg-[rgba(255,255,255,0.48)] border border-[#EDD9BC] rounded-[14px] p-4">
                                                        ...
                                                        <p className="text-[#1A0A00] mt-1 leading-6">{value}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
