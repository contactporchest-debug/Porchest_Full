    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.96 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 20, scale: 0.97 }}
                ...
                style={{ maxWidth: '720px', margin: '0 auto', background: 'rgba(255,255,255,0.98)', border: '1px solid rgba(155,111,80,0.14)', borderRadius: '36px', boxShadow: '0 32px 80px rgba(15,23,42,0.16)', overflow: 'hidden' }}>
                ...
                <div style={{ padding: '28px 32px', borderBottom: '1px solid rgba(148,163,184,0.22)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'linear-gradient(135deg,#f5f3ff,#eff6ff)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(155,111,80,0.15)', border: '1px solid rgba(155,111,80,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#9b6f50' }}>
                            <BarChart3 size={18} />
                        </div>
                        <div>
                ...
                <div style={{ padding: '80px 32px', textAlign: 'center' }}>
                    <div style={{ width: '72px', height: '72px', borderRadius: '22px', background: 'rgba(155,111,80,0.08)', border: '1px solid rgba(155,111,80,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', color: 'rgba(155,111,80,0.5)' }}>
                        <TrendingUp size={30} />
                    </div>
