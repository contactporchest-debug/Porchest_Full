                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p style={{ marginTop: '8px', fontSize: '14px', color: '#7A5030', lineHeight: 1.65, maxWidth: '600px' }}>
                            Notifications are tied to your collaboration workflow, so your brand profile must be complete before the portal can load them.
                        </p>
                        <Link
