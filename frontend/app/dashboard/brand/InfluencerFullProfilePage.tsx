...
import type { BrandInfluencerProfile, HistoricalSnapshot, MediaItem } from '@/types/brandInfluencer';
...
export default function InfluencerFullProfilePage({ influencerUserId }: FullProfileProps) {
    const [profile, setProfile] = useState<BrandInfluencerProfile | null>(null);
